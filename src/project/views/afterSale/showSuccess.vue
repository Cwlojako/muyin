<template>
  ...
  <div class='user-detail'>
    ...
    <el-col :span="18" class='user-detail-right'>
      <el-card>
        <div slot="header" class='box-card-header'>
          <span class='box-card-header-left'>转账资料</span>
        </div>
        <div class="text-item after-sale-img">
          <span class="text_label">转账凭证：</span>
          <el-avatar shape="square" :size="50" :fit="'fill'"
                     :src="'https://fuss10.elemecdn.com/e/5d/4a731a90594a4af544c0c25941171jpeg.jpeg'">
          </el-avatar>
        </div>
    ...
    <el-dialog
      title="审核通过"
      :visible.sync="passProps.visible"
      :modal-append-to-body='false'
      :append-to-body="true"
      width="50%"
      :before-close="handleClose">
    ...
    <el-dialog
      title="审核不通过"
      :visible.sync="dispassProps.visible"
      :modal-append-to-body='false'
      :append-to-body="true"
      width="50%"
      :before-close="handleClose">
  ...
  export default {
    ...
    methods: {
      ...
      handleClick(command){
        switch (command) {
          case '审核通过':
            this.passProps.visible = true
            break
          case '审核不通过':
            this.dispassProps.visible = true
            break
        }
      },
      ...
      handleClose() {
        this.passProps.visible = false;
        this.dispassProps.visible = false
      },
      handleSave() {
        this.passProps.visible = false;
        this.dispassProps.visible = false
