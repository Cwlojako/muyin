  ...
  <el-row class="page">
    ...
    <el-col :span="24">
      <el-table
        ...
        <el-table-column prop="user.phone" label="手机号码"></el-table-column>
        <el-table-column sortable prop="createTime" label="修改时间"></el-table-column>
...
<script>
  ...
  import {search, count, updateEnable, batchUpdateEnable} from '@/project/service/post'
